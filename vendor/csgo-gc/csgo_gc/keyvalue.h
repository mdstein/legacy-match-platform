...
public:
    ...
    // Strict policy files decode escaped quotes/backslashes and reject
    // duplicate keys and nesting deeper than 16.
    // Game schemas keep their original merge behavior by default.
    KeyValueFileResult ParseFromFileDetailed(const char *path, bool strict = false,
